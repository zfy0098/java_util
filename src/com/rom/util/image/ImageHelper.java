...
public class ImageHelper {
	...
	public static void scaleImageWithParams(String sourceImagePath, String destinationPath, int width, int height,
		...
		try {
			...
			bufferedImage = ImageIO.read(file);
			if (auto) {
				ArrayList<Integer> paramsArrayList = getAutoWidthAndHeight(bufferedImage, bufferedImage.getWidth(), bufferedImage.getHeight());
	...
	public static void main(String[] args) {
		ImageHelper.scaleImageWithParams("/IMG_0396.JPG", "/1.JPG", 0, 0, true, "JPG");
	}
}
